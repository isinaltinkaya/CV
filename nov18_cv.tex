...
\section{Laboratory Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Trainee, Advisor: Dr. Mehmet Somel}{August 2018 - present}
      \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Trainee, Advisor: Dr. Ergi Deniz \"{O}zsoy}{October 2015 - present}
      \resumeItemListStart
...
Tree of Evolution Bornova Anatolian Highschool Evolution Workshop (2012) \textit{(Organizer)} \\
