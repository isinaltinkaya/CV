...
\section{Research Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      %%Contributed to the HMMPloidy project by implementing various methods, including a genotype likelihood estimator for arbitrary N-ploidies, which culminated in a publication.
%Supported by the Erasmus+ Traineeship Grant that I was awarded.
%Gained advanced skills in programming and statistical analysis.
    \medskip
