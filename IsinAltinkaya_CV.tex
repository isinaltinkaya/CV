...
\section{Languages}
    ...
    \textbf{-}  \textbf{English:} Native-like fluency (ILR level R-$5$, S-$5$, L-$5$, W-$5$) \\
    \textbf{-}  \textbf{German:} Elementary proficiency (ILR level R-$1$, S-$1$, L-$0$, W-$0+$) \\
    \textbf{-}  \textbf{Danish:} Elementary proficiency (ILR level R-$1$, S-$1$, L-$0+$, W-$1$) \\
%\vspace{-0.8em}
