...
\href{https://isinaltinkaya.github.io/}{isinaltinkaya.github.com}
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Bioinformatics}
          {Detecting selection on gene networks with population genetics approach.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Phylogenomic Analyses}
          {Developing a pipeline using plant genomic data (RADSeq).}
    \resumeItemListEnd
