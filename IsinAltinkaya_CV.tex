...
\href {https://github.com/isinaltinkaya}{$\vcenter{\hbox{\includegraphics[scale=0.04]{icons/github_PNG23.png}/isinaltinkaya}}$} \hfill Luxemburger Str. 44, 50354 \\
\href {https://x.com/IsinAltinkaya}{$\vcenter{\hbox{\includegraphics[scale=0.04]{icons/Twitter_and_X_logos.png}}}$/isinaltinkaya}
\hfill Hürth, Cologne, Germany \\
\href{mailto:isinaltinkaya@gmail.com}{isinaltinkaya@gmail.com} $\sbullet[.5]$ \href{mailto:isin.altinkaya@uni-koeln.de}{isin.altinkaya@uni-koeln.de} \hfill \href{https://scholar.google.com/citations?user=DHpwS6oAAAAJ&hl=en&oi=ao}{$\vcenter{\hbox{\includegraphics[scale=0.08]{icons/google-scholar_orig_full.png}}}$} $\sbullet[.5]$
...
\section{Education}
  \cvSubHeadingListStart
    ...
    \cvSubheading
      ...
      {Faculty of Health and Medical Sciences, Globe Institute, Section for GeoGenetics} {2022/1 - 2025/4}
...
\section{Research Experience}
    \cvSubHeadingListStart
        ...
        {Collaborative Research Centre for Predictability in Evolution}
        {2026/9 - 2026/12}
        %  \vspace{-0.1em} 
...
\begin{flalign*}
\href{https://www.biorxiv.org/content/10.1101/2025.05.12.653431v2}{\textbf{[7]}} &\; \text{\textbf{Isin Altinkaya}, Lei Zhao, Rasmus Nielsen, Thorfinn S. Korneliussen. ngsAMOVA: A probabilistic framework for} && \\
&\; \text{Analysis of Molecular Variance, $d_{XY}$ and Neighbor-Joining trees with low depth sequencing data. \textit{bioRxiv} (2025)} && \\
&\; \text{(under review by \textit{Molecular Ecology and Resources})} && \\
\href{https://academic.oup.com/bioinformatics/article/41/4/btaf098/8056036}{\textbf{[6]}} &\; \text{\textbf{Isin Altinkaya}, Thorfinn S. Korneliussen, Rasmus Nielsen. vcfgl: A flexible genotype likelihood simulator for} && \\
&\; \text{VCF/BCF files. \textit{Bioinformatics} (2025)} \\
\href{https://www.biorxiv.org/content/10.1101/2024.12.02.626332v1}{\textbf{[5]}} &\; \text{Fulya E. Yediay [et al, including \textbf{Isin Altinkaya}]. Ancient genomics support deep divergence between Eastern and} && \\
&\; \text{Western Mediterranean Indo-European languages. \textit{bioRxiv} (2024) (under review by \textit{Nature})} && \\
...
&\; \text{Languages. \textit{bioRxiv} (2024) (under review by \textit{Nature})} && \\
  ...
  \cvSubHeadingListStart
    \cvSubheading
      ...
      \begin{enumerate}[label=\textbf{-},nosep,wide, labelindent=0pt]
        ...
        \item Utilized programming languages and tools such as \textbf{Python}, \textbf{R}, \textbf{JavaScript}, \textbf{HTML\&CSS}, \textbf{AWK}, and \textbf{Bash scripting} to perform data analysis and customized program development.
...
\overset{\textcolor{isored}{\text{  Expert  }}}{\text{Python}},\ \overset{\textcolor{isored}{\text{  Advanced  }}}{\text{C++}},\
\overset{\textcolor{isored}{\text{Intermediate}}}{\text{Rust}},\
\overset{\textcolor{isored}{\text{Intermediate}}}{\text{Perl}},\  
\overset{\textcolor{isored}{\text{Intermediate}}}{\text{Java}}$ \\
\smallskip
...
\textbf{Computational Statistics}, Department of Mathematical Sciences, University of Copenhagen, (2022) \\
\textbf{Advanced Topics in Data Analysis}, Faculty of Health and Medical Sciences, University of Copenhagen, (2021) \\
\textbf{Fundamentals in Computational Analysis of Large-Scale Datasets}, Faculty of Health and Medical Sciences, University of Copenhagen, (2021) \\
\textbf{RevBayes Workshop}, Topics: Tree inference from molecular data, evaluating MCMC performance, assessing model adequacy and macroevolutionary analyses, (2020) \\
...
\section{Languages}
    ...
    \textbf{-}  \textbf{English:} Near-native proficiency (TOEFL 2020 C2) (ILR level R-$5$, S-$5$, L-$5$, W-$5$) \\
    \textbf{-}  \textbf{German:} Elementary proficiency (ILR level R-$1$, S-$1$, L-$1$, W-$1$) \\
    \textbf{-}  \textbf{Danish:} Elementary proficiency (ILR level R-$1$, S-$1$, L-$1$, W-$1$) \\
%\vspace{-0.8em}
