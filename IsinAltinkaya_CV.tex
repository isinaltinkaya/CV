...
\href{https://isinaltinkaya.github.io/}{isinaltinkaya.github.io}
...
\section{Research Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Detecting selection on gene networks with population genetics approach}
          {For details, see 'Publications in Prep'.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{ANGSDgui}
          {A web user interface for the ANGSD software which is a probabilistic framework for analyzing next-generations equencing data. For details, see 'Publications in Prep'.}
        \resumeItem{\href {https://github.com/SamueleSoraggi/HMMploidy}{HMMploidy}}
          {A tool to infer ploidy levels from short-read sequencing data using Hidden Markov Models. For details, see 'Publications in Prep'.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{A novel phylogenomic pipeline for resolving evolutionary histories using RADseqdata}
          {For details see, 'Publications in Prep'.}
    \resumeItemListEnd
...
%--------SKILLS------------
\section{Skills}
\textbf{Programming languages}: Python, R, Bash, JavaScript, C++ \\
