...
\hfill \href{https://scholar.google.com/citations?user=DHpwS6oAAAAJ&hl=en&oi=ao}{Google Scholar} $\sbullet[.5]$ \href{https://orcid.org/0000-0002-6364-3332}{ORCID}\orcidlink{0000-0002-6364-3332} $\sbullet[.5]$ \href{https://www.linkedin.com/in/altinkayaisin/}{LinkedIn} \\

%I\c{s}{\i}n Alt{\i}nkaya

\vspace{0.5cm}
\color{isored} \hline \color{black}
\vspace{0.5cm}


I am a Ph.D. researcher in Bioinformatics and Evolutionary Genomics at the University of Copenhagen (expected March 2025), dedicated to developing statistical frameworks and fast, efficient software to tackle complex bioinformatics challenges. My expertise in Python, R, C, and C++, along with hands-on experience in production-grade software, pipeline optimization with Snakemake, and server administration, enables me to design robust computational solutions. I have contributed to multidisciplinary collaborations resulting in high-impact publications, including a recent Nature paper. With a strong foundation in biology and bioinformatics, I bring diverse perspectives to algorithm development, blending technical innovation with a focus on biological insights. I am eager to apply my skills and experience to advance SOPHiA GENETICS’ mission of improving healthcare through data-driven solutions.
...
\section{Research Experience}
    \cvSubHeadingListStart
        ...
        {2024/09 - Present (expected 2024/12)}
...
&\; \text{VCF/BCF files. \textit{bioRxiv} (2024).} \\ 
...
\textbf{Manuscripts Under Review}\vspace{-0.5em}
\begin{flalign*}
\textbf{[1]} &\; \text{Fulya E. Yediay [et al, including \textbf{Isin Altinkaya}]. Ancient genomics support deep divergence between eastern} && \\ 
&\; \text{and western Mediterranean Indo-European languages. (currently under review by \textit{Nature}).} && \\
\end{flalign*}

\smallskip \vspace{-2em}
